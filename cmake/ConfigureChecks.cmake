...
if(USE_SYSTEM_Curses)
    ...
    message(STATUS "")
    set(_msg "Looking for curses with Unicode support")
    message(STATUS "${_msg}")
...
if(USE_SYSTEM_LIBMPDEC)
    ...
    find_path(LIBMPDEC_INCLUDE_DIR mpdecimal.h)
    message(STATUS "LIBMPDEC_INCLUDE_DIR=${LIBMPDEC_INCLUDE_DIR}")
endif()
...
set(MAJOR_IN_SYSMACROS ${HAVE_SYS_SYSMACROS_H})
check_include_files(sys/mkdev.h HAVE_SYS_MKDEV_H)
set(MAJOR_IN_MKDEV ${HAVE_SYS_MKDEV_H})
